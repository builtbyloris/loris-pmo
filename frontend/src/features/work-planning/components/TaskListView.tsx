...
export function TaskListView({ tasks, milestones, dependencies, readOnly, onStatusChange }: { tasks: Task[]; milestones: Milestone[]; dependencies: TaskDependency[]; readOnly: boolean; onStatusChange: (taskId: string, status: TaskStatus) => Promise<boolean> }) {
