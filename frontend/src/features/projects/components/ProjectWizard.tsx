      ...
      <form id="project-wizard-form" onSubmit={next} className="wizard-form">
        ...
        {step === 2 && <div className="planning-stack">
          <div className="form-grid">
            ...
            <label className="span-2"><span>{t("projects.fields.plannedBudget")}</span><div className="money-input"><i>€</i><input type="number" min="0" step="0.01" value={draft.planned_budget ?? "0"} onChange={(e) => update("planned_budget", e.target.value)} /></div>{errors.planned_budget && <small className="field-error">{errors.planned_budget}</small>}</label>
          </div>
