...
export interface Activity { id: string; actor_user_id: string; actor_email: string | null; action: string; entity_type: string; entity_id: string; entity_name: string | null; changes: Record<string, unknown> | null; created_at: string; }
